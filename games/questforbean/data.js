var enemies = {
    ...
    "grasslurker": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["corruptedclaw","sandstorm?hp=60;atk=40","healorb?manause=0.5;heal=60"],
        deck: {},
...
var relics = {
    ...
    lightningbean: {
        ...
        advdesc: "Drawing costs 1 mana less, and reloading resets all card's cooldowns.",
        rarity: 5,
        attr: 1,
        attrincrease: 0,
        attrtype: "int",
...
var cards = {
    ...
    bloodstainedspear: {
        ...
        sound: "slash.mp3",
        advdesc: "When a spearman dies, remove them from the deck in the current battle. Permanently gain stat atk and hp. (does not increase current card)",
        upgrades: {
            1: {
                name: "Undying",
