var enemies = {
    ...
    "goldslime": {
        ...
        discards: 0,
        inventory: {},
        simpledeck: ["etherealguardian","gold","jester"],
        deck: {},
    ...
    "phaserwizard": {
        ...
        discards: 0,
        inventory: {},
        simpledeck: ["phaser","wizard","bubblemancer"],
        deck: {},
    ...
    "helloitsme": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["teslacoil?level=1;manause=1","bandit","weakener?level=1","wizard","bus"],
        deck: {},
    ...
    "fakecoins": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["cannoneer","juggernaut","wizard","solarprism","bandit","gold"],
        deck: {},
    ...
    "cheesedino": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["solarprism?level=1","oblivion","wizard","spearman?level=2","managenerator","healbubble"],
        deck: {},
        mods: ["FlameTouch{2,1}"],
    },
    "bandits": {
    ...
    "leafo": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["vine?hp=40","healorb"],
        deck: {},
        mods: ["Tank{20}","Healing{300}"],
    },
    "wisespirits": {
        name: "wisespirits",
    ...
    "lordk": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["bandit","wizard","spearman","flamethrower","ninja","cannoneer?level=1"],
        deck: {},
    ...
    "trafficlord": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["bandit","wizard?level=2","spearman?level=2","flamethrower","stopsign","managenerator","solarprism"],
        deck: {},
        mods: ["Tank{20}","Healing{20}","CardBlock{33}","CardDisable{10}"],
        fightimg: "trafficlordfight.png",
    },
    "madmechanic": {
        name: "madmechanic",
        formal: "Mad Mechanic",
        ...
        discards: 5,
        inventory: {},
        simpledeck: ["turret?stat=10","managenerator?stat=2","factory","charger?stat=30;"],
        simplerelics: ["engineerswrench","gregsbox"],
        deck: {},
        aitype: "discard",
        mods: ["Strength{50}"],
    },
    "cursedtome": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["atkpotion","wizard?level=1","clonebox","bubblemancer","charger","managenerator","solarprism?level=1"],
        deck: {},
        mods: ["Strength{100}","QuickUse{1}","Tank{20}","Healing{100}"],
        fightimg: "ancientlibrary_resized.png",
    },
    "owllibrarian": {
        name: "owllibrarian",
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["atkpotion","wizard?level=1","weakener?level=1","bubblemancer","reaper?level=1","managenerator","solarprism"],
        deck: {},
    ...
    "stoneguardian": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["stonewall","healorb","juggernaut"],
        deck: {},
        mods: ["Strength{50}","Tank{100}"],
    },
    "grasslurker": {
        name: "grasslurker",
        formal: "Grass Lurker",
        desc: "They lurk in the grass....",
        managain: 7,
        maxdiscards: 1,
        coinsgive: 30,
        // battle stats
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["corruptedclaw","sandstorm?hp=60;atk=40","healorb?;heal=60"],
        deck: {},
        mods: ["Heal{30}","Tank{50}"],
    },
    "redstarburst": {
        name: "redstarburst",
        formal: "The Red Star",
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["flamethrower?level=2","juggernaut?level=1","solarprism?level=1"],
        deck: {},
        mods: ["Tank{50}","FlameTouch{10,2}"],
        fightimg:"crimsondesert.png",
    },
    "fisher": {
        name: "fisher",
        formal: "The Fisherman",
        desc: "An angry fisherman who doesn't want you polluting his waters.",
        managain: 7,
        maxdiscards: 1,
        coinsgive:120,
        // battle stats
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["fishingrod","rottenglob"],
        deck: {},
        mods: ["Tank{20}"],
        fightimg:"fishingdock.png",
    },
    "fisher2": {
        name: "fisher2",
        formal: "The Fisherman: FINAL FORM",
        desc: "An angry fisherman.Too angry. THE ANGRY.",
        managain: 17,
        maxdiscards: 1,
        coinsgive:200,
        // battle stats
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["fishingrod?cool=0;manause=1;coolleft=0","rottenglob?manause=0;poison=100"],
        deck: {},
        mods: ["Tank{20}"],
        fightimg:"fishingdock.png",
    },
    "cashier": {
        ...
        discards: 1,
        inventory: {},
        simpledeck: ["gold?hp=90","managenerator","spearman?level=2","sniper?level=2","turret?level=2"],
        simplerelics: ["feebolumbullets"],
        deck: {},
        mods: ["Tank{20}","QuickUse{1}","Strength{50}"],
        fightimg:"",
    },
}
var locations = {
    "home": {
        ...
        loretext: "A few days ago, UncleMan threatened to evict you, saying that you're a lazy couch potato that does nothing. Since becoming a homeless beggar is the last thing you want to do, you ask him for ways to stay in the house. || You: What can I do to stay here? || UncleMan: You have to earn your keep! I'll give you one simple task: .text-white-hi{.text-yell{.text-bold{Find the Bean Duplicator.}}} If you can get that relic, then I'll give you lifelong permission to stay here. || A rare relic found only in the .text-red{dangerous} mountains, visible shaking started. You knew that protesting would do nothing, so, starting with only .text-bold{20 coda coins and 2 spearmen}, you began your journey to prevent yourself from getting evicted.",
    ...
    "andreasappear": {
        ...
        formal: "Road To Coda",
        desc: "The long path to Coda, one of the biggest cities in the world. There, you'll be able to stock up on cards to continue your journey.",
        loretext: 'On the road, a man comes up to you, noticing your cards. He says name is Andreas, and he offers to give you .text-bold{"powerful"} cards if you can beat him, along with .text-bold{30} coda coins. However, if you lose, you have to give him all of your cards. It seems sketchy, but some better cards would be very useful.',
    ...
    "goldslimeappear": {
        ...
        formal: "Road To Coda",
        desc: "The long path to Coda, one of the biggest cities in the world. There, you'll be able to stock up on cards to continue your journey.",
        loretext: "You kept walking, until you started hearing a faint splashing noise. || .text-bold{PLOP. PLOP. PLOP.} || Something shiny was in the distance, shiny and golden. It was slowly bouncing towards you. || .text-bold{PLOP. SPLAP. PLOP.} || Eventually, you could make out what it was. It was a golden slime going after you. Seems like there's only one way out of this..",
    ...
    "goldslimevictory": {
        ...
        loretext: "You saw the mushy blob melt into smaller globs, now fading away. Once it died away, it left behind traces of gold .text-bold{(approximately 50 coda coins)}, a large, .text-bold{golden shovel}, and .text-bold{one card}. Check your inventory for a new relic!",
        //special: "noshop|gaincard|gainrelic",
        special: {"gaincard":{cardloottable:"standard",rerolls:1},"gainrelic":{relicgain:"goldenshovel"}},
    ...
    "phaserwizardappear": {
        ...
        formal: "Road To Coda",
        desc: "The long path to Coda, one of the biggest cities in the world. There, you'll be able to stock up on cards to continue your journey.",
        loretext: "On the road, you saw a strange man in a hat. You couldn't make out his details, as he was moving very quickly. It seemed as if he was .text-white-hi{.text-bold{.text-purp{teleporting..}}}||Wait.. Is he getting closer?||Oh no..",
    ...
    "phaserwizardvictory": {
        ...
        loretext: "Phasing in and out, the mysterious wizard eventually disappeared. You picked up the card it left behind. You also found a .text-bold{strange, blurry bullet} on the ground. What could it be?",
        //special: "noshop|gaincard|gainrelic",
    ...
    "taverngroupvictory": {
        ...
        proceedtext: "Battle Janjo for a chance to get 120 coda coins.",
        proceedspecial: "fight|janjo",
        nextloc: "janjovictory",
        skipallowed: true,
    },
    "janjovictory": {
        ...
        special: {"gaincard":{
            cardgain: "flamethrower?coolleft=0;level=1",
            rerolls: 0,
        }},
    ...
    "helloitsmeappear": {
        ...
        formal: "Deric's Dance Club",
        desc: "A wild and frivolous club where people can vibe, shout, and dance in a vivid array of lights.",
        loretext: "The first thing that caught your attention was the DJ's set of prismatic cards, all of them being rare. However, you were unable to talk to the DJ, as just then, a challenger, who went by the name of 'Helloitsme123', approached. || Helloitsme123: .text-bold{You are so oblivious..} || You: What? || Helloitsme123: You .text-bold{have not seen the light.} || You: I don't understand. What light? || Helloitsme123: You are simpy a .text-bold{pawn in a chess board of kings and queens.} You know .text-bold{nothing.}",
        locimg: "danceclub.png",
        proceedtext: "What does he mean?",
    ...
    "fakecoinsvictory": {
        ...
        alttext: "Being content with the amount of coins you had, you decided to decline the opportunity and continue on with your journey.",
        proceedtext: "Explore more of the club.",
        locimg: "danceclub.png",
        nextloc: "danceclub2",
    },
    ...
    "power": {
        name: "power",
        formal: "Power",
        desc: "What allows you to achieve.",
        loretext: "YOU CAN DO ANYTHING AS LONG AS YOU LOCK IN HARD ENOUGH",
    ...
    "power_discard": {
        name: "power_discard",
        formal: "Cloaked Human",
        desc: "A strange man in a cloak, walking up to you.",
        loretext: "As you continued through the dance club, a man out of nowhere popped up. || ???: You have quite the reputation in our community. We have been told that you have lots of power. Perhaps, you could trade me some of your power for an extra discard?",
        proceedtext: "Explore more.",
        special: {"custom":{
            id: "power",
            choices: {
                1: {
                    ...
                    h2: "Trade Power",
                    p: "Trade some of your power for an extra discard.",
                    "maxdiscards": 2,
                    loseitem: ["power",1],
                },
            }
    ...
    "power_mana": {
        ...
        formal: "Cloaked Human",
        desc: "A strange man in a cloak, walking up to you.",
        loretext: "As you continued through the dance club, a man out of nowhere popped up. || ???: You have quite the reputation in our community. We have been told that you have lots of power. Perhaps, you could trade me some of your power for extra mana gain?",
        proceedtext: "Explore more.",
        special: {"custom":{
            id: "power",
            choices: {
                1: {
                    h2: "Trade Power",
                    p: "Trade some of your power for extra mana.",
                    "managain": 1,
                    loseitem: ["power",1],
                },
            }
    ...
    "beanfactory2": {
        ...
        loretext: "It was nice to have some sleep after more than a day of none at all. Feeling better, you left the hotel to get to visit the Beanmelon Factory. Standing in a corner was a strange, red man with an empty expression. || ???: .text-bold{Did you know, that if you remove 3 spearmen from your deck, you'll be able to make something out of their deaths?} || You: Oh really? How do you know that? || Arsonist: I burn down things for a living. Once, I burnt down 3 spearmen's huts. They got pretty mad. || You: Can you burn down anything for me? || Arsonist: If you have gasoline and a torch. If not, keep moving.",
        special: {
            "conchange": {
                con: "c1",
                loretext: "It was nice to have some sleep after more than a day of none at all. Feeling better, you left the hotel to get to visit the Beanmelon Factory. Standing in a corner was a strange, red man with an empty expression. || ???: .text-bold{Did you know, that if you remove 3 spearmen from your deck, you'll be able to make something out of their deaths?} || You: Oh really? How do you know that? || Arsonist: I burn down things for a living. Once, I burnt down 3 spearmen's huts. They got pretty mad. || You: Can you burn down anything for me? || Arsonist: Hmm.. You seem like quite the firebrand. I can burn down the factory. UncleMan won't like it.",
                addspecial: {"setpart":{choices:{1:{setpart: ["2a"],specialopt: true,specialheader: "Burn Down the Factory",specialdesc: "Surely nothing will go wrong.",}}}},
            },
        },
        locimg:"beanfactory.png",
        proceedtext: "Continue Throughout the Factory",
    ...
    "beanfactory": {
        ...
        formal: "Bean Factory Entrance",
        desc: "The entrance to a Beanmelon Factory. Hopefully you'll be able to enter. After all, you are the owner's nephew.",
        loretext: "It was nice to have some sleep after more than a day of none at all. Feeling better, you left the hotel to get to visit the Beanmelon Factory. At the entrance, you met a strange dinosaur-humanoid, with a block of cheese with googly eyes as their head. You thought it was a statue, until the dinosaur thing started talking to you. || Cheese Dino: Are you here to talk about .text-bold{Lord K?} || You: No.. who's that? || Cheese Dino: You see that guy on the poster? || The picture on the poster showed a .text-bold{ginormous}, .text-green{green} dude wearing a crown and a cape, at least .text-bold{double the height of the hotel} you were just in, if you looked at the trees in the background of the photo. || You: So.. Who is this Lord K? || Cheese Dino: Well, he's this giant fellow that's been causing a lot of disruption, .text-bold{destroying cities} and whatnot. There's a bounty on him. Anyone who can defeat him will get .text-yell{.text-bold{1000 coda coins.}} Just bring his crown here, and I'll use the Artifact Confirmation Expert machine to confirm it. || You: 1000? || Cheese Dino: Yep. If you want to get the prize, you'll have to be able to get cards strong enough to deal with Lord K. Won't be easy. || You: Where can I find him? || Cheese Dino: Oh, .text-bold{somewhere in the forests} that follow. || You: Well, can I pass through now? || Cheese Dino: No. || You: Why? || Cheese Dino: I'd like to see how .text-bold{good you are} first.",
        proceedtext: "Battle Cheese Dino to Get into the Bean Factory.",
    ...
    "leafo": {
        name: "leafo",
        formal: "Leafo",
        desc: "A strange, greenish, leaf-like creature.",
        loretext: "As you went along the road, trying to find Lord K, you found many things. A comically large crowbar. An unnecessarily large amount of coda coins scattered across the ground (unfortunately, they weren't real, so they were worthless). And.. a strange leaf monster. || The leaf monster was very viny, having thorns and spikes on it. It slowly approached, its small legs walking towards you. ",
        proceedtext: "Deal with the Leafo.",
        proceedspecial: "fight|leafo",
        nextloc: "leafovictory",
    },
    "leafovictory": {
        name: "leafovictory",
        formal: "Boraps Path",
        desc: "The road to Coda, formally known as the Boraps Path, as it technically goes through all of Boraps.",
        loretext: "Finally, you defeated the leafos. The forest where Lord K resided was very large. You could not distinguish rock from rock. Tree from tree. You still knew that you were making progress, however. || Wasn't that rock there before? Or is it a different rock? Hmm... || Hey, that tree looks familiar. ",
    ...
    "trafficlordappear": {
        ...
        formal: "Road to Coda",
        desc: "A ro.",
        loretext: "One question that you were still dying to know the answer for was: Where is everyone? Sure, there was that one rest stop, but else than that, you haven't met a single person on the road. What must be the cause of this? If so, how can this stop millions of people from traveling? || After some time, you felt a difference in the air. It was as if.. it was even more lonely. Lonelier than it was when you were already at max lonely. How is that possible? You kept walking, hoping to cover as many miles as possible. Why do cars have to be so expensive? || Eventually, you saw a big.. thing. It was entirely made of traffic cones, with big, mad eyes in the front. It was almost as large as Lord K, but there was something about it that didn't make you feel good.. || Traffic Lord: .text-bold{I am the .text-large{Traffic Lord}}, and I you are .text-bold{not} going to be allowed to continue along this road! || You: What? Why? I've walked like .text-italic{.text-number{60}} miles already! It's been days! || Traffic Lord: Who asked? Who cares? I am here to take all of your belongings, so I can become the richest being in the world! || You: I'm sorry, but that title belongs to my uncle. || Traffic Lord: Are you sure? Is BeanMelon truly the greatest? Or is it all a .text-large{.text-red{crumbling facade?}} || You: What? What.. do you mean? || Traffic Lord: .text-italic{It's all a lie.. Have you not seen?}", 
    ...
    "madmechanicappear": {
        name: "madmechanicappear",
        formal: "Mad Mechanic",
        desc: "A mechanic that is quite mad.",
        loretext: "Continuing to explore the futuristic store, you noticed a mechanic in the corner that seemed to be raging about one of his creations. It seemed to not be working, so you decided to come closer and see if you could help. || Mad Mechanic: .text-bold{ARGGHH!!} THIS .text-bold{STUPID} ROBOT!! || You: Do you need help? || Mad Mechanic: Not from a LOSER like YOU! YOU ARE A NUISANCE JUST LIKE THIS ROBOT!! || You: Why? What did I do wrong? || Mad Mechanic: That wire over there, are you .text-bold{BLIND?} YOU .text-bold{STEPPED ON IT} AND IT .text-bold{BROKE THE ROBOT}!!",
        proceedtext: "Sort it out with the mechanic.",
        proceedspecial: "fight|madmechanic",
        nextloc: "madmechanicvictory",
    },
    "madmechanicvictory": {
        name: "madmechanicvictory",
        formal: "Mad Mechanic",
        desc: "A mechanic that is quite mad.",
        loretext: "Mad Mechanic: MMMM... || .text-bold{.text-maxi{AAAHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH}} || Being distracted by his own rage, you noticed that he had dropped his wrench.",
        special: {"gainrelic": {"relicgain":"engineerswrench","rerolls":0,}},
        proceedtext: "Leave the mechanic.",
        nextloc: "jamodarcards3",
    },
    "jamodarcards3": {
        name: "jamodarcards3",
    ...
    "ancientlibrary": {
        ...
        special: {"setpart":{choices:{1:{setpart: ["1a"],specialheader: "Enter the Library",
        specialdesc: "Who knows what knowledge it holds..",}}}},
        specialopt: true,
        //excludegui: true,
        locimg: "ancientlibrary_resized.png",
    ...
    "ancientlibrary1": {
        ...
        locimg: "ancientlibrary_resized.png",
        nextloc: "ancientlibrary1",
    },
    "moneymagic": {
        name: "moneymagic",
        formal: "Golden Scroll",
        desc: "A shimmering scroll lodged in between two books.",
        loretext: "Taking a right turn and going upstairs, you noticed a faint glow. It was a golden scroll, radiating with mana. Do you take it?",
        special: {"custom":{choices:{1:{h2:"Take the Golden Scroll",p:"Make it rain.",gainitem:["moneymagic",10]}}}},
        proceedtext: "Keep exploring.",
        locimg: "ancientlibrary_resized.png",
        nextloc: "ancientlibrary1",
    },
    ...
    "stoneguardianappear": {
        name: "stoneguardianappear",
        formal: "The Stone Guardian",
        desc: "A large, ancient statue made of stone.",
        loretext: "As you got closer and closer to the outskirts of Coda, you met with the Stone Guardian, a large statue meant to defend. || Despite not having much mobility, you still thought about fighting it. To do so, you'd have to deal with the field of stones and rocks surrounding, but not without a reward.",
        proceedtext: "Continue to the Path North, or fight the Stone Guardian.",
        proceedspecial: "fight|stoneguardian",
        skipallowed: true,
        skipalt: "none",
        nextloc: "pathnorth",
    },
    "stoneguardianvictory": {
        name: "stoneguardianvictory",
    ...
    "pathnorth2": {
        ...
        formal: "The Path North",
        desc: "A path to the north.",
        loretext: "As you continued towards the north, it eventually became night. You rest a little bit on the ground, hoping to have a good nigh's rest. Fortunately for you, you woke up in the morning completely fine. || Walking further, the forest and grass eventually turned into a large, grass field getting yellower and yellower the more you went. According to your map, you were reaching Filo, now in the vast fields that covered it. ",
        proceedtext: "Continue to the Filo Fields",
        nextloc: "filofields",
    },
    "filofields": {
        name: "filofields",
        formal: "Filo Fields",
        desc: "Large, grassy fields of emptiness.",
        loretext: "The Filo Fields were devoid of life, except for the occasional farms. It was easily traversable now, but you knew it was only going to get warmer as you went east towards the deserts. Thinking about what was to come, you pondered about what gear you should get to deal with the harsh conditions later on.",
        proceedtext: "Continue Walking",
        nextloc: "filofields",
        locimg: "filofields.png",
    },
    "grasslurker": {
        name: "grasslurker",
        formal: "Grass Lurker",
        desc: "Large, grassy fields of emptiness.",
        loretext: "The once large road had now faded into a thin, dirt path that led through the fields. The only thing that prevented it from getting completely swallowed by the massive fields were the occasional visitors, like you, keeping the path somewhat visible. || The breezy winds blew the grasses, creating noise every few seconds. It was impossible to tell if anything was there, with the dust blowing by constantly. Not seeing anything in front of a you, a strange, grass-like creature suddenly jumped at you.",
        proceedtext: "Battle the Grass Lurker",
        proceedspecial: "fight|grasslurker",
        nextloc: "grasslurkervictory",
        locimg: "filofields.png",
    },
    "grasslurkervictory": {
        name: "grasslurkervictory",
        formal: "Grass Lurker",
        desc: "A now lifeless body on the floor to be consumed by the infinite dust.",
        loretext: "Defeating the strange creature that had leaped at you, it fell down and lay limp. It was a very peculiar being, being made of what seemed to just be dry grass to camouflage, its only striking feature being its sharp, venomous claws. You decided to keep going, knowing that this was only the start of the increasing danger of the fields.",
        proceedtext: "Continue Walking",
        nextloc: "filofields",
        locimg: "filofields.png",
    },
    ...
    "filodesert": {
        name: "filodesert",
        formal: "Filo Desert",
        desc: "A large, dry, and scorching hot desert.",
        loretext: "Leaving the Filo town center, you began to see the gradual decrease from town to desert. Instead of the dry and windy fields that appeared before, this desert was incredibly hot, making you feel like you were being burned alive. The sky was turning a slight red, and signs of any life were disappearing.",
        proceedtext: "Continue Across the Desert",
        nextloc: "redstarburstappear",
        locimg:"crimsondesert.png",
    },
    "redstarburstappear": {
        name: "redstarburstappear",
        formal: "The Crimson Desert",
        desc: "A red desert filled with crimson hues.",
        loretext: "While slowly walking across the desert, you started to see a light change in the sky. The slight red turned into a deep crimson, and the sand was changing to a more orange color. It was getting hotter and hotter, and you could no longer walk without feeling immense pain. || Looking up at the sky, you noticed something off. An incredibly bright, red, star in the sky, bursting with heat.",
        proceedspecial: "fight|redstarburst",
        proceedtext: "Battle the Heat",
        nextloc: "filomeat",
        locimg:"crimsondesert.png",
    },
    "redstarburstvictory": {
    ...
    "lostexplorer": {
        ...
        special:{"custom":{choices:{1:{
            ...
            heal: 0,
            maxheal: 0,
            actiontext: "You walked away, worried about your own health. "
        }}}},
        forceaction: true,
        proceedtext: "Continue Across the Desert",
        nextloc: "redstarburstappear",
    ...
    "darkwaystone": {
        ...
        proceedtext: "Keep walking.",
        special: {"setpart":{choices:{1:{setpart: ["2a"],specialheader: "Use the Waystone",
        specialdesc: "Where does it lead?",}}}},
        specialopt: true,
        //excludegui: true,
        
        nextloc: "feeboledocks",
    },
    "feeboledocks": {
        name: "feeboledocks",
        formal: "Feebole Docks",
        desc: "A busy shore docked with ships and fishing.",
        loretext: "After travelling through the entire desert, you made your way to the feebole docks. You could hear the waves crashing against the rocky shore, with many wooden bridges built for fishing boats. You approached a fisherman, who offered you a deal. || Fisherman: Ya know, I don't offer this to many people. I just caught quite a rare fish that can give you lots of benefits, but no one's buying it right now. So what about this, you can buy this stonefish I caught for only 100 CC. I promise you it'll help.",
        special: {
            "custom": {
                choices: {1: {h2: "Buy the Stonefish", p: "He said it's useful..", cost: 100,gainitem:["stonefish",2]}}
            }
        },
        proceedtext: "Keep walking.",
        nextloc: "fisherappear",
        locimg: "fishingdock.png",
    },
    "fisherappear": {
        name: "fisherappear",
        formal: "Disgruntled Fisherman",
        desc: "A fisherman who is done with fools like you.",
        loretext: "Fisher: Aye! What 're you folks doin' over here? Wasting my space to play your silly little games? || You: But, .text-bold{I'm on a quest.. for bean} || Fisher: I don't give a dillywagging 'bout yer quest for blublu! I'm tired of you people ruining my fishing experience.",
        proceedspecial: "fight|fisher",
        proceedtext: "Fight the Fisherman",
        nextloc: "fishervictory",
        locimg: "fishingdock.png",
    },
    "fishervictory": {
        name: "fishervictory",
        formal: "Disgruntled Fisherman",
        desc: "A fisherman who is done with fools like you.",
        loretext: "Fisher: Hmm.. Seems like you guys were a bit stronger than I thought. Anyways, shoo! I don't want to see any of y'all in my dock, or else I'll have to enter my .text-bold{FINAL FORM.}",
        proceedtext: "Leave the Dock",
        nextloc: "codastreets2",
        locimg: "fishingdock.png",
    },
    "fisherappear2": {
        name: "fisherappear2",
        formal: "Disgruntled Fisherman: FINAL FORM",
        desc: "A STRONG fisherman who is done with fools like you.",
        loretext: "Fisher: Aye! What 're you folks doin' over here? Wasting my space to play your silly little games? || You: But, .text-bold{I'm on a quest.. for bean} || Fisher: I don't give a dillywagging 'bout yer quest for blublu! I'm tired of you people ruining my fishing experience.",
        proceedspecial: "fight|fisher",
        proceedtext: "Fight the Fisherman",
        nextloc: "codastreets2",
    ...
    "fishervictory2": {
        ...
        formal: "Disgruntled Fisherman: FINAL FORM",
        desc: "A fisherman who is done with fools like you.",
        loretext: "Fisher: H-how? Impossible. You.. You have defeated.. my .text-bold{FINAL FORM}. I wish you the best of luck on your journey.",
        proceedtext: "Leave the Dock",
        nextloc: "codastreets2",
        locimg: "fishingdock.png",
    },
    "marcotunnel": {
        name: "marcotunnel",
        formal: "Strange Tunnel",
        desc: "A random tunnel in the ground.",
        loretext: "Leaving the docks, you walked towards the main city. However, you noticed a strange hole in the ground. You wanted to investigate what was inside, but it was covered by a metal grate. It seemed to go very deep, and you were able to see a few paths. Maybe you can enter another time..",
        proceedtext: "Explore Feebole City",
        nextloc: "miningstore",
    },
    "miningstore": {
        name: "miningstore",
        formal: "Mining Store",
        desc: "A shop in Feebole that supplies gear for mining.",
        loretext: "Thinking about the tunnel you found, you suddenly found yourself at a mining store. You could see an array of pickaxes and tools hung on the wall, as well as tons of crates that contained a strange material. You decided to ask the woman at the counter what it was. || You: Um.. What are those crates over there? || Cashier: Those are the innovative material .text-feebolum{feebolum}. They're stronger than diamond, yet easier to obtain than iron. It's amazing! Tools can be made much stronger using feebolum. Is there anything you want to buy? || You: Well, I'm not so sure about this feebolum.. || Cashier: I can show you its true power.",
        proceedtext: "Test Out the Feebolum",
        proceedspecial: "fight|cashier",
        skipallowed: true,
        nextloc: "cashiervictory",
    },
    "cashiervictory": {
        name: "cashiervictory",
        formal: "Mining Store",
        desc: "A shop in Feebole that supplies gear for mining.",
        loretext: "You defeated the cashier! From your observations, feebolum can make metal tools stronger, like applying Brittle I and dealing more damage. As a gift, the cashier decided to give you a free sample of feebolum, most likely to get you to come back next time.",
        alttext: "You decided to not test out the feebolum. The cashier had already told you about how strong and efficient it was, and that was enough for you to get a basic understanding.",
        proceedtext: "Leave the Shop",
        special: {"gainrelic": {relicgain:"feebolumbullets"}},
        nextloc: "quarry",
    },
    "quarry": {
        name: "quarry",
        formal: "Quarry",
        desc: "A large field of rocks and stones.",
        loretext: "Leaving the store, you went towards the nearby quarry. You could see many miners hacking away at the rocks, likely used for construction. You could see various entrances that led towards a .text-bold{large network of mines}. On the left, you also saw a faint path that led towards a .text-bold{.text-purp{mythic forest}}.",
        proceedtext: "What to do?",
        forceaction: true,
        special: {"setpart":{
            choices:{
                1:{setpart: ["2a"],specialheader: "Feebole Mines",specialdesc:"Venture the mines."},
                2:{setpart:["2b"],specialheader: "Mystic Forest",specialdesc:"Discover the mystifying forest."}},
            }
        },
        nextloc: "zeend",
    },
    "zeend": {
        name: "zeend",
        formal: "THE END?",
        desc: "You have beaten the current version. Good job!",
        loretext: "You see a .text-bold{laid down 8} in front of you, with a strange, .text-purp{violet aura} surrounding it. The end is never the end is never the end is never the end is never the end is never the end is never the end is never ....",
...
var relics = {
    ...
    partyhat: {
        ...
        advdesc: "Heal 5% of your max health every time you win a battle, at the cost of 5 coins.",
        rarity: 2,
        attr: 5,
        attrincrease: 5,
        attrtype: "int",
    ...
    gregsbox: {
        name: "gregsbox",
        formal: "Greg's Box",
        desc: "Box for recycling.",
        advdesc: "Discarding cards gives 1 extra mana along with 10 coins.",
        rarity: 3,
        attr: [1,10], // mana gain & coin gain
        attrincrease: [0.5,10],
        attrtype: "arr",
        img: "gregsbox.png",
    },
    ...
    quincyspillar: {
        ...
        advdesc: "Attacks that deal less than 45 damage give you 10 coda coins.",
        rarity: 1,
        attr: 10,
        attrincrease: 5,
        attrtype: "int",
    ...
    /*orbmix: {
        ...
        advdesc: "Every time a healing orb is used, apply a random positive effect to that card.",
        rarity: 1,
        attr: 1,
        attrincrease: 1,
        attrdesc: "Time & scale of the random effect.",
        attrtype: "int",
        img: "orbmix.png",
    },*/
    morningglory: {
        ...
        advdesc: "Deal double damage on the first turn of every battle, but lose 15 health if the attacked enemy doesn't die.",
        rarity: 1,
        attr: 1,
        attrincrease: 0.25,
        attrtype: "int",
    ...
    blueprint: {
        ...
        advdesc: "Gain 2 extra starting mana.",
        rarity: 3,
        attr: 2,
        attrincrease: 1,
        attrtype: "int",
    ...
    engineerswrench: {
        name: "engineerswrench",
        formal: "Engineer's Wrench",
        desc: "A rusty wrench that has fixed and tinkered hundreds of mechanisms.",
        advdesc: "Discarding cards now provide scraps, which allows mechanical cards to gain 5% damage and health per scrap.",
        rarity: 3,
        attr: 5,
        attrincrease: 2,
        attrtype: "int",
        img: "engineerswrench.png",
    },
    watch: {
        name: "watch",
        formal: "Rusty Watch",
    ...
    phasershot: {
        name: "phasershot",
        formal: "Phaser Shot",
        desc: "A distorted bullet phasing in and out, occasionally glitching and jittering.",
        advdesc: "Sniper damage attacks all opponent cards, losing 30 damage per card pierced.",
        rarity: 4,
        attr: 30,
        attrdesc: "Damage lost per pierce",
        attrincrease: -3,
        attrtype: "int",
        img: "phasershot.png",
    },
    ...
    goldenshovel: {
        name: "goldenshovel",
        formal: "Golden Shovel",
        desc: "A shiny, golden shovel.",
        advdesc: "Discarding an empty square costs 3 mana but spawns a piece of gold, which you can then discard for 40 coins.",
        rarity: 4,
        attr: 40,
        attrincrease: 15,
        attrtype: "int",
        img: "goldenshovel.png",
    },
    divineshield: {
        name: "divineshield",
        formal: "Divine Shield",
        desc: "A glimmering, gray and blue shield made of fine metals.",
        advdesc: "Shield-type cards like ethereal guardian and juggernaut gain 50 health and give a special divinity effect to cards, which makes the shielders take their damage.",
        rarity: 4,
        attr: 50,
        attrincrease: 15,
        attrtype: "int",
        img: "divineshield.png",
    },
    feebolumbullets: {
        name: "feebolumbullets",
        formal: "Feebolum Bullets",
        desc: "A greenish-brown pack of bullets that quickly eliminate threats.",
        advdesc: "All shooting type cards apply Brittle I on use.",
        rarity: 4,
        attr: 1,
        attrincrease: 1,
        attrtype: "int",
        img: "feebolumbullets.png",
    },
    quincyorb: {
        name: "quincyorb",
        formal: "Quincy Orb",
        desc: "A rainbow orb of light with various Quincys rotating inside of it.",
        advdesc: "All loot tables are randomized.",
        rarity: 5,
        attr: 1,
        attrincrease: 1,
        attrtype: "int",
    ...
    lightningbean: {
        name: "lightningbean",
        formal: "Lightning Bean",
        desc: "A greyish-blue bean can with zapping lightning around it.",
        advdesc: "Drawing costs 1 mana less, and reloading resets all card's cooldowns and applies Shock III to all opponent cards.",
        rarity: 5,
        attr: 1,
        attrincrease: 0,
        attrtype: "int",
        img: "lightningbean.png",
    },
    enchantedbean: {
        name: "enchantedbean",
        formal: "Enchanted Bean",
        desc: "A purplish bean can with amethyst fire and sparkles around it.",
        advdesc: "Magic cards give 0.5 mana per kill. They inflict AmeFire I on use.",
        rarity: 5,
        attr: 1,
        attrincrease: 0,
        attrtype: "int",
        img: "enchantedbean.png",
    },
    stormbean: {
        name: "stormbean",
        formal: "Storm Bean",
        desc: "A hazy purplish bean can with spreading mist around it. Summons the storm.",
        advdesc: "Every 5 turns, draw 3 random cards from your deck and gain 8 mana. A base of x1 of damage dealt that turn will transfer to your health. And every opponent card destroyed will grant 1 mana.",
        rarity: 5,
        attr: 1,
        attrdesc: "x multiplier for the damage dealt healed.",
        attrincrease: 0,
        attrtype: "int",
        img: "stormbean.png",
    },
...
var cards = {
    ...
    wizard: {
        ...
        upgrades: {
            ...
            3: {
                ...
                stats: [["hp",20]],
                cost: 400,
                desc: "Every soul in inventory gives this card +1 range.",
            },
        },
        subtypes: ["magic"],
    },
    ...
    soul: {
        name: "soul",
        formal: "Soul",
        atk: 20, // these stats are actually going to be 1/4th of the keeper's stats
        hp: 20,
        ammo: 1,
        maxammo: 1,
        manause: 0,
        ...
        stat: 2,
        killcount: 0,
        statdesc: "Health given to soulkeeper after attacking.",
        keeper: undefined,
        desc:"A trapped soul, forced to fight for its overlord.",
        funnyname: "SOULI",
        type: "Attack",
        img: "soul.png",
        subtypes: ["magic","soul"],
    ...
    flamethrower: {
        ...
        upgrades: {
            1: {
                ...
                stats: [["atk",4],["hp",15]],
                cost: 120,
                desc: "20% chance of throwing a bomb that flamifies 4 different opponent cards.",
            },
            2: {
                name: "Fahrenheit 452",
                stats: [["atk",2],["hp",15]],
    ...
    supplycrate: {
        ...
        manause: 1,
        stat: 10,
        statdesc: "Ammo given multiplier",
        cool: 0,
        coolleft: 0,
    ...
    atkpotion: {
        ...
        upgrades: {
            1: {
                ...
                stats: [["hp",10],["stat",25]],
                cost: 150,
                desc: "Damage multiplier goes from x1.5 to x1.75. Every wrath card in inventory boosts this by .25x",
            }
        },
        subtypes: ["magic"],
    },
    ...
    energycapsule: {
        ...
        maxammo: 1,
        stat: 1,
        statdesc: "Multiplier damage given to chargrs.",
        coolleft: 0,
        cool: 2,
    ...
    reaper: {
        ...
        upgrades: {
            1: {
                stats: [["atk",10],["hp",15]],
                cost: 500,
                desc: "Has a 10% chance of instant-killing.",
            }
        },
        subtypes: ["magic"],
    },
    ...
    bank: {
        ...
        maxammo: 1,
        stat: 2,
        statdesc: "Mana gained every turn",
        storedmana: 0,
        maxmana:15,
        coolleft: 0,
        cool: 1,
    ...
    vine: {
        ...
        maxammo: 4,
        stat: 10,
        statdesc: "Damage dealt back when attacked",
        cool: 1,
        coolleft: 0,
        manause: 0.5,
        desc:"Deals thorny damage back to attackers.",
        funnyname: "VINERY",
        type: "Attack",
        obtainable: false,
        img: "vine.png",
    ...
    gold: {
        ...
        hp: 50,
        stat: 1,
        statdesc: "Richness, aka how much coins are given",
        desc:"A fine piece of gold. Maybe discard it?",
        funnyname: "GOLDALICIOUS",
        type: "Object",
        obtainable: false,
        img: "gold.png",
        upgrades: {
    ...
    stonewall: {
        ...
        formal: "Stone Wall",
        hp: 200,
        desc:"Serves as an obstacle.",
        funnyname: "STONEWALLED",
        type: "Object",
        img: "stonewall.png",
        obtainable: false,
    },
    corruptedclaw: {
        ...
        maxammo: 1,
        stat: 10,
        statdesc: "Critical hit chance",
        cool: 1,
        coolleft: 1,
        manause: 1.5,
        desc:"Throws a powerful, poison slash that infects the enemy.",
        funnyname: "CLAWCORRUPTINO",
        type: "Attack",
        obtainable: false,
        img: "corruptedclaw.png",
        sound: "slash.mp3",
        upgrades: {
            1: {
                name: "Lethal Tips",
                stats: [["atk",10],["hp",10],["stat",10],["poison",5]],
                cost: 300,
                desc: "Apply more poison",
            }
        },
        subtypes: ["poison"],
    },
    sandstorm: {
        ...
        manause: 1,
        stat: 10,
        desc:"Worsens the poison of attackers. Heals 10 every card drawn.",
        funnyname: "DARUDE SANDSTORM",
        type: "Attack",
        obtainable: false,
        img: "sandstorm.png",
        sound: "whirl.mp3",
        upgrades: {
            1: {
                stats: [["atk",20],["hp",20],["poison",5],["stat",10]],
                cost: 300,
                desc: "[ability not found]",
            }
        },
    ...
    bloodstainedspear: {
        name: "bloodstainedspear",
        formal: "Bloodstained Spear",
        hp: 30,
        atk: 35,
        ammo: 1,
        maxammo: 1,
        stat: 5,
        statdesc: "Increase in stats per death",
        cool: 1,
        coolleft: 1,
        manause: 1,
        desc:"The spearmen have not died in vain.",
        funnyname: "BLOODSTANINI SPEARININI",
        type: "Attack",
        img: "bloodstainedspear.png",
        sound: "slash.mp3",
        advdesc: "When a spearman dies, gain all other spearmen 5 health and atk. Grant this card 15 health.",
        upgrades: {
            1: {
                name: "Vengeance",
                stats: [["maxammo",1],["ammo",1],["stat",2]],
                cost: 200,
                desc: "Create wrath cards when spearmen die.",
            }
        },
        subtypes: [],
    },
    radiantfists: {
        ...
        sound: "punch.mp3",
        advdesc: "When used on any card, that card will be predicted. If that card attacks the following turn, the card will be parried and radiant fists will deal (stat*atk of card) damage back to it.",
        upgrades: {
            1: {
                name: "Guard Up",
                stats: [["hp",10],["atk",5]],
    ...
    fishingrod: {
        ...
        coolleft: 1,
        manause: 5,
        desc:"An swift rod that reels in opponent cards.",
        funnyname: "ROTTERNO GLOBULA",
        type: "Action",
        img: "fishingrod.png",
        sound: "reel.mp3",
        advdesc: "Steals selected card from opponent inventory",
        upgrades: {
        },
    },
    spiritstaff: {
        ...
        shock: 5,
        stat: 10,
        statdesc: "Healing done",
        cool: 2,
        coolleft: 1,
        manause: 2,
        desc:"A wooden staff with a glowing, blue crystal.",
        funnyname: "SPIRITITIS STAFFITUS",
        type: "Attack",
        img: "spiritstaff.png",
        sound: "spell1.mp3",
        advdesc: "Shocks opponent cards and heals a random ally every time the opponent card is used. If Spirit Army soulkeeper is in inventory, summons souls.",
        upgrades: {
            1: {
                name: "Spirit Range",
                stats: [["atk",-10],["shock",3]],
                cost: 200,
                desc: "Attack 3 enemies.",
            }
        },
        subtypes: ["soul","magic","electricity"],
    },
    stopsign: {
        name: "stopsign",
        formal: "Stop Sign",
        ...
        maxammo: 1,
        stat: 5,
        statdesc: "Cooldown inflicted",
        cool: 3,
        coolleft: 2,
        manause: 8,
        exhaust: true,
        desc:"A heavy, red stop sign that will not let anyone pass.",
        funnyname: "STAPANO SIGNYA",
        type: "Attack",
        img: "stopsign.png",
        sound: "bash.mp3",
        advdesc: "Stuns all cards in the player's inventory, applies X cooldown to the last card.",
        upgrades: {
            1: {
                name: "Earth Rupture",
                stats: [["hp",10],["atk",10]],
                cost: 300,
                desc: "Applies Brittle II to every single card.",
            }
        },
        subtypes: [],
    },
...
var items = {
    fullstomach: {
        formal: "Full Stomach",
        name:"fullstomach",
        desc:"Your stomach is full, granting you a hearty boost.",
        advdesc:"Cards start with 1 less cooldown, and they deal 20% more damage.",
        attr: 0,
    ...
    flaming: {
        formal: "Flaming",
        name:"flaming",
        desc:"You're on fire, burning quickly.",
        advdesc:"Cards inflict fire, but are also burning.",
        attr: 0,
        attrname: "Battles Left",
    },
    blessing: {
    ...
    power: {
        formal: "Power",
        name: "power",
        desc: "THE ABILITY TO ACHIEVE, DOMINANCE ABOVE OTHERS",
        attr: 0,
        attrname: "Amount",
    },
    stonefish: {
        formal: "Stonefish",
        name: "stonefish",
        desc: "When a card is under 40hp, increase its cooldown by 1 and apply regeneration 20 for 2 turns.",
        attr: 0,
        attrname: "Battles Left",
    },
    moneymagic: {
        formal: "Money Magic",
        name: "moneymagic",
        desc: "Convert 1/4 of your coins into mana at the start of the battle.",
        attr: 0,
        attrname: "Battles Left",
    },
}
var effects = {
    ...
    "burning": {
        formal: "Burning",
        name: "burning",
        desc: "Deals 8*scale damage to affected cards every turn.",
        foil: "burningfoil.png",
    },
    "camouflaged": {
        formal: "Camouflaged",
        name: "camouflaged",
        desc: "Card cannot be damage directly. Damage transfers to next card/opponent",
        img: "camofoil.png",
    },
    "confused": {
        formal: "Confused",
...
var cardLootTables = {
    "standard": {
        // excluded: reaper, froster, oblivion, clonebox, drawback, bubblemancer
        spearman: 10,
        bloodstainedspear: 7,
        wizard: 10,
        turret: 10,
    ...
    "filo": {
        ...
        // new additions: corrupted claw, sandstorm, glob, spiritstaff, bubblemancer
        spearman: 4,
        bloodstainedspear:8,
        turret: 6,
        sniper: 3,
...
var eventTextStyles = {
    ...
    "stun": {
        style: "color:khaki;font-weight:bold;-webkit-text-stroke:1px black;"
    },
    "danger": {
        style: "color:red;font-weight:bold;-webkit-text-stroke:0.5px maroon;"
    },
    "mana": {
        style: "color:indigo;font-weight:bold;-webkit-text-stroke:0.5px darkturquoise;"
    },
    "frost": {
        style: "color:cornflowerblue;-webkit-text-stroke:0.5px darkblue;"
    },
    "critical": {
        style: "color:rgb(60,20,0);font-weight:bold;-webkit-text-stroke:0.2px black;"
    },
    "phaser": {
...
var unlocks = {
    // a = new item, b = new enemy, c = new location, d = new character
    a1: {
        name: "a1",
        formal: "Massacre",
    ...
    a2: {
        name: "a2",
        formal: "The Insatiable",
        desc: "You want good items? Here's some good items.",
    },
    c1: {
        name:"c1",
        formal: "Sparkling Heat",
        desc: "Owarp has never been this brightly lit at night!",
    },
    d1: {
        name: "d1",
        formal: "Charity",
